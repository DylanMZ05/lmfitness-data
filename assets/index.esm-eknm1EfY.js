import{r as b,_ as T,C as A,a as k,E as H,F as K,o as we,L as Ie,g as W,b as ye,d as be,i as Te,c as x,e as Ae,v as ve,f as Se}from"./index-nXXxDEyq.js";const Y="@firebase/installations",D="0.6.17";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="installations",rt="installations-internal",ot=e=>{const t=e.getProvider("app").getImmediate(),n=st(t),a=k(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},ct=e=>{const t=e.getProvider("app").getImmediate(),n=k(t,fe).getImmediate();return{getId:()=>nt(n),getToken:i=>at(n,i)}};function lt(){T(new A(fe,ot,"PUBLIC")),T(new A(rt,ct,"PRIVATE"))}lt();b(Y,D);b(Y,D,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(e){if(!e.startsWith(N)){const t=d.create("invalid-gtag-resource",{gtagURL:e});return u.warn(t.message),""}return e}function pe(e){return Promise.all(e.map(t=>t.catch(n=>n)))}function mt(e,t){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(e,t)),n}function wt(e,t){const n=mt("firebase-js-sdk-policy",{createScriptURL:ht}),a=document.createElement("script"),i=`${N}?l=${e}&id=${t}`;a.src=n?n==null?void 0:n.createScriptURL(i):i,a.async=!0,document.head.appendChild(a)}function It(e){let t=[];return Array.isArray(window[e])?t=window[e]:window[e]=t,t}async function yt(e,t,n,a,i,s){const r=a[i];try{if(r)await t[r];else{const c=(await pe(n)).find(l=>l.measurementId===i);c&&await t[c.appId]}}catch(o){u.error(o)}e("config",i,s)}async function bt(e,t,n,a,i){try{let s=[];if(i&&i.send_to){let r=i.send_to;Array.isArray(r)||(r=[r]);const o=await pe(n);for(const c of r){const l=o.find(g=>g.measurementId===c),f=l&&t[l.appId];if(f)s.push(f);else{s=[];break}}}s.length===0&&(s=Object.values(t)),await Promise.all(s),e("event",a,i||{})}catch(s){u.error(s)}}function Tt(e,t,n,a){async function i(s,...r){try{if(s==="event"){const[o,c]=r;await bt(e,t,n,o,c)}else if(s==="config"){const[o,c]=r;await yt(e,t,n,a,o,c)}else if(s==="consent"){const[o,c]=r;e("consent",o,c)}else if(s==="get"){const[o,c,l]=r;e("get",o,c,l)}else if(s==="set"){const[o]=r;e("set",o)}else e(s,...r)}catch(o){u.error(o)}}return i}function At(e,t,n,a,i){let s=function(...r){window[a].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=Tt(s,e,t,n),{gtagCore:s,wrappedGtag:window[i]}}function vt(e){const t=window.document.getElementsByTagName("script");for(const n of Object.values(t))if(n.src&&n.src.includes(N)&&n.src.includes(e))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(t){this.app=t}_delete(){return delete I[this.app.options.appId],Promise.resolve()}}let I={},q=[];const B={};let _="dataLayer",xt="gtag",V,me,U=!1;function jt(){const e=[];if(Te()&&e.push("This is a browser extension environment."),Se()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function Lt(e,t,n){jt();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(I[a]!=null)throw d.create("already-exists",{id:a});if(!U){It(_);const{wrappedGtag:s,gtagCore:r}=At(I,q,B,_,xt);me=s,V=r,U=!0}return I[a]=$t(e,q,B,t,V,_,n),new Nt(e)}function zt(e=ye()){e=W(e);const t=k(e,S);return t.isInitialized()?t.getImmediate():qt(e)}function qt(e,t={}){const n=k(e,S);if(n.isInitialized()){const i=n.getImmediate();if(be(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}function Bt(e,t,n,a){e=W(e),Ft(me,I[e.app.options.appId],t,n,a).catch(i=>u.error(i))}const z="@firebase/analytics",G="0.10.16";function Vt(){T(new A(S,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Lt(a,i,n)},"PUBLIC")),T(new A("analytics-internal",e,"PRIVATE")),b(z,G),b(z,G,"esm2017");function e(t){try{const n=t.getProvider(S).getImmediate();return{logEvent:(a,i,s)=>Bt(n,a,i,s)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Vt();export{zt as getAnalytics,qt as initializeAnalytics,Bt as logEvent};
