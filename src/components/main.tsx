...
const Main: React.FC = () => {
    ...
    return (
        <main className="h-screen max-h-[800px] flex flex-col justify-center items-center text-white bg-[url('/assets/fondo-2.jpeg')] bg-cover bg-center md:flex-row md:max-w-screen md:justify-around">
