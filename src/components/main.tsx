...
const Main: React.FC = () => {
    ...
    return (
        <main className="h-screen max-h-[800px] flex flex-col justify-center items-center text-white bg-stone-950 bg-[200%] md:flex-row md:max-w-screen md:justify-around">
            <div className="w-screen flex flex-col items-center px-6 text-center md:w-max md:text-start md:items-start">
                ...
                <h2 className="text-[18px] leading-tight md:text-[24px]">LLEVA TUS ENTRENAMIENTOS<br className="lg:hidden"></br>AL <br className="hidden lg:block xl:hidden"></br>SIGUIENTE NIVEL</h2>
